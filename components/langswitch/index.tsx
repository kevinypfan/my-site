      ...
      <Menu>
        {({ open }) => (
          <div>
            ...
            >
              <MenuItems
                className="absolute right-0 z-50 mt-2 w-15 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-800"
                        ...
                        <MenuItem>
                          {({ focus }) => (
                            ...
                            >
                              ...
                              <Image
                                src={`/static/flags/${newLocale}.svg`}
                                alt={newLocale}
                                width={30}
                                height={26}
                              />
